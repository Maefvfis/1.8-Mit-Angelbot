...
public class CSVSchildManager {
	...
	public static void getShopschilder(int X, int Z) {
		...
		mc.thePlayer.addChatComponentMessage(new ChatComponentText("--------------------- CSV EXPORT ---------------------"));
		mc.thePlayer.addChatComponentMessage(new ChatComponentText("Shops aus CSV Geladen: " + String.valueOf(SchilderImprotedFromCSV)));
		mc.thePlayer.addChatComponentMessage(new ChatComponentText("Shops im Umkreis Gefunden: " + String.valueOf(SchilderFound)));
		mc.thePlayer.addChatComponentMessage(new ChatComponentText("neue Shops in CSV geschrieben: " + String.valueOf(SchilderAdded)));
